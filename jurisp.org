...
Este acórdão *é de incluir na referência como decisão parcialmente
incorreta.*

     :PROPERTIES:
     :CUSTOM_ID: este-acórdão-é-de-incluir-na-referência-como-decisão-parcialmente-incorreta.
     :END:
